...
% STEP 2 - calculate penalty for each output unit in the output layer 3

d3 = A3 - Y;

% STEP 3 - caclulate penalty for each output unit in the output layers2 

% Theta2 = Theta2(:,2:end);

sig_grad = sigmoidGradient (Z2);

d2 = (d3 * Theta2(:,2:end)).* sig_grad;
